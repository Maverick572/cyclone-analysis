...
export default function useDistrictLayer({
    ...
    import("leaflet").then(L => {
      ...
      const layer = L.geoJSON(geojson, {
        ...
        onEachFeature: (feature, layer) => {
          ...
          const unit = mode === "flood" ? "intensity" : "mm/day"

          const valueText = mode === "flood" ? v.toFixed(2) : v.toFixed(1)
          ...
          layer.on({
                ...
                .setContent(`
                  <div style="font-family:Space Mono;font-size:0.7rem;min-width:160px;">
                    ...
                    <div style="color:#e8f0ff;font-size:0.85rem;">
                      ${valueText}
                      <span style="color:#4a6080">${unit}</span>
                    </div>
                  </div>
                `)
                .openOn(map)
            ...
            mouseout: (e) => {
              ...
              e.target.setStyle({
                ...
                color: isSelected ? "#ffffff" : "#243650"
              })
  ...
  }, [geojson, rainfallData, mode, selectedDistrict])
